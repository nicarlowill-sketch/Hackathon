...
// --- Jamaica outline omitted for brevity (keep your existing JAMAICA_OUTLINE here) ---
...
return L.divIcon({
html: <div class="custom-marker" style="background-color: ${colors[category]}"> <span class="marker-icon">${icons[category]}</span> </div>,
